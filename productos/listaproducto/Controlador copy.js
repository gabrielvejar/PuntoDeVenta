    ...
    function listarProductos() {
        ...
        ajax(ruta, params, metodo, async,json,function(respuesta){
            ...
            for (i in respuesta){
                ...
                var btnMod2 = '" href="javascript:;"><button class="btn btn-info">Modificar</button></a>'
                ...
                var btnElim2 = '" href="javascript:;"><button class="btn btn-danger">Eliminar</button></a>'
                ...
                if (respuesta[i][4] == ""){
                    ...
                    cuerpo += ' <div class="img-producto" id="'+respuesta[i][2]+'"><div><img src="/puntodeventa/img/productos/sinimagen.jpg"  width="70%"></div><div>' + btnMod1 + respuesta[i][2] +btnMod2 +btnElim1 + respuesta[i][2] +btnElim2 + '</div>';
                } else {
                    // cuerpo += "<tr>";
                    ...
                    cuerpo += ' <div class="img-producto" id="'+respuesta[i][2]+'"><div><img src="/puntodeventa/img/productos/' + respuesta[i][4] +'"  width="70%"></div><div>'  + btnMod1 + respuesta[i][2] +btnMod2 +btnElim1 + respuesta[i][2] +btnElim2 + '</div>';
                    // cuerpo += "</tr>";
                }
                cuerpo += "</td>";
                ...
                cuerpo += "<td>" + respuesta[i][6] + "</td>";
                cuerpo += "<td>$" + respuesta[i][3] + "</td>";
