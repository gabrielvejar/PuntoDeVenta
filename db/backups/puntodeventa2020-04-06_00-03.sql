...
LANGUAGE plpgsql;
--
-- Definition for function fn_venta_temporal_i_letra_id_diario (OID = 33320) : 
--
...
BEGIN
	...
	INSERT INTO public.venta_temporal(id_usuario, letra_id_diario) 
...
--
-- Definition for view vw_ventas2 (OID = 33325) : 
--
