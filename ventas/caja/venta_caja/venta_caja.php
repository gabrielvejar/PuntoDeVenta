    ...
    <!-- fin -->
                ...
                <div id="botonera" class="lam collapse show">
                    <div id="btns1" class=" collapse show">
                        <button id="btn-efectivo" class="btn btn-success btn-abajo btn-pago"><i class="fas fa-money-bill" aria-hidden="true"></i> Efectivo</button>
                        <button id="btn-tarjeta" class="btn btn-info btn-abajo btn-pago"><i class="far fa-credit-card" aria-hidden="true"></i> Tarjeta</button>
                        <button id="btn-anular" class="btn btn-danger btn-abajo">Anular Venta</button>
                    </div>
                    <div id="btns-pago-efectivo" class=" collapse">
                        <button id="btn-pagar" class="btn btn-success btn-pago"><i class="fas fa-hand-holding-usd"></i> Pagar</button>
