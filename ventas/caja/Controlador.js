...
function listarDetalle() {
    ...
    for (var i=0; i < listaDetalleDB.length; i++) {
        numFila++;
            ...
            // TODO boton borrar 
            html +='<td><i class="fa fa-times x-detalle" aria-hidden="true"  onclick="borrarLineaDetalledb('+listaDetalleDB[i].id_detalle+')">';
            html +='</tr>';
    ...
    $('#idatencion').text(listaDetalleDB[i].id_diario);
