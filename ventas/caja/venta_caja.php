...
<input type="hidden" id="ruta" value="<?php echo $ruta?>">
    ...
    <div id="encabezado" class="container">
        <h1 id="titulo">CAJA - ID ATENCIÓN: <span><b>21</span></b></h1><button id="btn-cerrar" class="btn btn-danger">X</button>
    </div>
    ...
    <div id="columna2" class="columna">
        <div id="totales" class="lam">
            <div id="total" class="total">
                <span>Total $</span><input type="number" name="total" id="total" class="input-total">
            </div>
            
            <div id="pago-efectivo" class="collapse">
                <div id="efectivo" class="total pago-efectivo">
                    <span>Efectivo $</span><input type="number" name="total" id="total" class="input-total">
                </div>
                <div id="vuelto" class="total pago-efectivo">
                    <span>Vuelto $</span><input type="number" name="total" id="total" class="input-total">
                </div>
